...
We build on the work of @bauchEarlyWarningSignals2016 by extending their old-growth forest model to a two-patch fishery model (Figure \ref{Conceptual}). The fish population models adapted from @bauchEarlyWarningSignals2016 are as follows:
