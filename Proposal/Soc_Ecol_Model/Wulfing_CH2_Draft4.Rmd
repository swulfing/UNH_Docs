...
(ref:influenceasym) The difference in increasing social pressure within population 1 (the $d_1$ parameter is increased down the columns of graphs) versus increasing social pressure from populaiton 1 onto population 1 (the $\rho_2$ parameter is increased across rows of graphs). 
