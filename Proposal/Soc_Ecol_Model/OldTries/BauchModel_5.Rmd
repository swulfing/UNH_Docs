...
$\frac{dX_1}{dt} =  k_1X_1(1-X_1)[\frac{1}{P_1+c_1} - w_1 + d_1(2X_1-1)] + k_2d_2(1 - \frac{x_2}{1-x_2})$

$\frac{dP_2}{dt} = r_2P_2(1-P_2)-\frac{h_2*P_2(1-X_2)}{P_2 + s_2} + \rho_2 * \frac{P_1 - P_2}{2}$

$\frac{dX_2}{dt} =  k_2X_2(1-X_2)[\frac{1}{P_2+c_2} - w_2 + k_1d_1(1 - \frac{x_1}{1-x_1})$
...
Bauch.Coupled <- function (t, y, params) {
  ...
  dX_1dt <- k_1 * X_1 * (1-X_1) * ((1/(P_1 + c_1)) - w_1 + d_1*(2*X_1 - 1)) + X_1 * k_2 * d_2 * (1 - (X_2/(1 - X_2)))
  dX_2dt <- k_2 * X_2 * (1-X_2) * ((1/(P_2 + c_2)) - w_2 + d_2*(2*X_2 - 1)) + X_2 * k_1 * d_1 * (1 - (X_1/(1 - X_1)))
