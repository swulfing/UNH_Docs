...
Bauch.Coupled <- function (t, y, params) {
  ...
  prop_1 <- params["prop_1"] # Influence of pop 1 on pop 2
  prop_2 <- params["prop_2"] # Influence of pop 2 on pop 1
  
  ## now code the model equations
  dP_1dt <- R_1 * P_1 * (1-P_1) - (h_1 * P_1 * (1-X_1))/(P_1+s_1) + roe_1 * (P_2 - P_1)/2
  dP_2dt <- R_2 * P_2 * (1-P_2) - (h_2 * P_2 * (1-X_2))/(P_2+s_2) + roe_2 * (P_1 - P_2)/2
  
  dX_1dt <- k_1 * X_1 * (1-X_1) *(1/(P_1 + c_1) - w_1 + d_1*(2*X_1 - 1)) - prop_1 * X_1 * (2* X_1 - 1)^2 + prop_1 * (1 - X_1) * (2* X_1 - 1)^2
  dX_2dt <- k_2 * X_2 * (1-X_2) *(1/(P_2 + c_2) - w_2 + d_2*(2*X_2 - 1))- prop_2 * X_2 * (2* X_2 - 1)^2 + prop_2 * (1 - X_2) * (2* X_2 - 1)^2
