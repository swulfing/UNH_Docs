...
(ref:twographs) The effect of changing rho 1 and rho 2 on final dynamics of F1 (a) and F2 (b) using parameters from Table 2. Data was run for 200 years


```{r TwoGraphs, results = 'asis', echo = FALSE, fig.show = "hold", out.width = "50%", fig.cap = '(ref:twographs) \\label{TwoGraphs}'}
