...
(ref:fishUncoupled) a) Oscillatory behavior of the model in @bauchEarlyWarningSignals2016 where $r = 0.06$, $s = 0.8$, $h = 0.1$, $k = 0.17$, $\omega = 1$, $c = 0.6$, $d = 0.3$. This is comparted to our model, b) which used the same parameter values with the addition of $i = 0.2$, $\rho = 0.3$.
