...
WRITE ABOUT BAUCH MODEL

(ref:fishUncoupled) WRITE THIS
...
(ref:dispersionscenario_Slow) An example of the dynamics we're showing EXPLAIN MORE

```{r rhoExplore, fig.cap = '(ref:rhoexplore) \\label{rhoExplore}'}
...
(ref:rhoexplore) Explain how this is after 100 years or whatever

```{r iExplore, results = 'asis', echo = FALSE, fig.show = "hold", out.width = "50%", fig.cap = '(ref:iexplore) \\label{iExplore}'}
...
finalDynamics1_long <- gather(finalDynamics, plot, Population, F1:F2, factor_key=TRUE)
...
finalDynamics2_long <- gather(finalDynamics, plot, Population, F1:F2, factor_key=TRUE)
...
(ref:iexplore) Explain how this is after 100 years or whatever
...
(ref:sensitivity) FIGURE OUT WHICH IS BEST
...
(ref:rhoparamplane) ALSO ADD LEGEND

```{r iParamPlane, warning = FALSE, fig.cap = '(ref:iparamplane) \\label{iParamPlane}'}
