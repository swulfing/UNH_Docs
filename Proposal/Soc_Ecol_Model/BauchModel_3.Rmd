...
$\frac{dX_1}{dt} =  k_1X_1(1-X_1)[\frac{1}{P_1+c_1} - w_1 + d_1(2X_1-1)] + k_2X_1(1-X_2)[\frac{1}{P_1+c_1} - w_1 + d_2(2X_2-1)]$

$\frac{dP_2}{dt} = r_2P_2(1-P_2)-\frac{h_2*P_2(1-X_2)}{P_2 + s_2} + \rho_2 * \frac{P_1 - P_2}{2}$

$\frac{dX_2}{dt} =  k_2X_2(1-X_2)[\frac{1}{P_2+c_2} - w_2 + d_2(2X_2-1)] + k_1X_2(1-X_1)[\frac{1}{P_2+c_2} - w_2 + d_1(2X_1-1)]$
...
```{r popplane_testk, fig.cap = "k population planes 0 to 100"}
popplane(4, 100)
