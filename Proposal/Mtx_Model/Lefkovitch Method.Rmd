...
```
## Note
Adapted from Levkovitch(1963, 1964 a,b) study on cigarette beetle. From page 142 in Caswell book
...
Calculated A matrix
```{r show A, results = 'asis', echo = FALSE, fig.cap = "Calculated Stage-Based Matrix"}
write_matex(A)
```
...
1. This model doesn't include the b0 values by adding an extra column of 1's to beginning of X mtx
