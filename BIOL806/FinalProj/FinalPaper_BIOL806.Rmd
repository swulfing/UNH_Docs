...
```{r Rdata, results = "asis", echo = FALSE, warning = FALSE, message = FALSE}
...
knitr::kable(my_matrix ,  caption = "O. cyanea Age-Based Matrix")

```

```{r mtxCalc, echo = FALSE, warning = FALSE, message = FALSE, fig.cap = "Projected *O. Cyanea* population based on Age-Matrix"}
